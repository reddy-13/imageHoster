...
public class ImageRepository {
    ...
    public boolean checkImageTitle(String imgTitle) {
    	EntityManager em = emf.createEntityManager();
    	try {
	    	TypedQuery<Image> typedQuery = em.createQuery("SELECT i from Image i where i.title =:title", Image.class).setParameter("title", imgTitle);
	        Image image = typedQuery.getSingleResult();
	    	if(image != null) {
	    		return true;
	    	}
